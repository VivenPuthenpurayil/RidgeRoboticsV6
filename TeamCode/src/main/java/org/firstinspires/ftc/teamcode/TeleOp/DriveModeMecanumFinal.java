...
public class DriveModeMecanumFinal extends FunctionsNew{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            float fb  = -gamepad1.left_stick_y; // Main Directions y-axis
            float rl =  gamepad1.left_stick_x;  // Main Directions x-axis

            float y2 = -gamepad1.right_stick_y; // Diagonal Directions y-axis
            float x2 = gamepad1.right_stick_x;  // Diagonal Directions x-axis

            boolean rs = gamepad1.right_stick_button;  // Button Directions y-axis
            boolean ls = gamepad1.left_stick_button;   // Button Directions x-axis
